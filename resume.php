...
<head>
	...
	<title>Cody Farrey - Computer Science</title>
...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #64C2EC;">
		<a class="navbar-brand" href="/index.php">Cody Farrey</a>
	...
	<main role="main" class="container">
			<div class="cf-template">
				<h1>Cody's Resume Template</h1>
				<p class="lead">This is the start to my website.<br> I will continue working on it after I get off of work. <br> Should try to go through a design process before proceeding.</p>
				<h6>This is a code example</h6><br>
			</div>
	</main>
